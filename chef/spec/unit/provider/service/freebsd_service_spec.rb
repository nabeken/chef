...
RC_SAMPLE
    ...
    it "should get the service name from the rcscript if it has a name variable" do
      @provider.should_receive(:service_enable_variable_name).and_return("#{@current_resource.service_name}_enable")
      @provider.load_current_resource
    end
...
RC_SAMPLE
    ...
    describe "when rcvar returns foobar_enable" do
      before do
        @rcvar_stdout = StringIO.new(<<-RCVAR_SAMPLE)
# apache22
#
# apache22_enable="YES"
#   (default: "")
